package khorsun.springtest.MVC.config;
...
@Configuration
@ComponentScan("khorsun.springtest")
@EnableWebMvc
@EnableJpaRepositories("khorsun.springtest.MVC.repositories")
...
public class SpringConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("khorsun.springtest.MVC.models");
    ...
    public PlatformTransactionManager transactionManager() {
      ...
      /* Hibernate configuration without SpringJPA*/
//    @Bean
//    public LocalSessionFactoryBean sessionFactory() {
//        LocalSessionFactoryBean sessionFactory = new LocalSessionFactoryBean();
//        sessionFactory.setDataSource(dataSource());
//        sessionFactory.setPackagesToScan("khorsun.springtest.MVC.models");
